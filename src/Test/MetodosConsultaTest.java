	...
	void recogerConsultaTest() {
		...
		try {
			...
			resul3.executeUpdate("Insert into `" + ManagerAbstract.TABLE_CONSULTA + "`"
					...
					+ "' , '" + precioNuevo + "' , '" + fechaNueva + "' , '" + horaNueva + "' , '" + dniNuevo + "' , '"
					+ idAnimalNuevo + "');");
			...
			assertEquals(resultado,
					"Consulta [idConsulta=900, precio=51.0, animal=Pez [, nombreAnimal=Anuk, idAnimal=900, edad=2, especie=Perro, sexo=M, cliente=null], empleado=Empleado [antiguedad=6, salario=2400.0, especializacion=Admin, nombre=Ander, apellido=De la Iglesia Perex, dni=22761890D, direccion=Praza Mario, 6, 13º F, contrasenya=2], fecha=2023-02-13, hora=13:55:36]");
